...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '3cb90ab7a3024ffbbd283e20a8b25ade',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '欧耶熊猫人', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '闲着没事就会把池池的动态放到这里', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lovenest.qzz.io', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '爱之巢, lovenest', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20262130号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20262130', // 备案查询链接，如果用了萌备等备案请在这里填写
